...
__export(dist_exports, {
  CloudflareSocket: () => CloudflareSocket
});
function dump(data) {
...
var import_events, CloudflareSocket, debug;
var init_dist = __esm({
  "node_modules/pg-cloudflare/dist/index.js"() {
    import_events = __toModule(require("events"));
    CloudflareSocket = class extends import_events.EventEmitter {
      constructor(ssl) {
        super();
        this.ssl = ssl;
        this.writable = false;
  ...
  "node_modules/pg/lib/stream.js"(exports, module2) {
    module2.exports.getStream = function getStream(ssl) {
      ...
      if (typeof net.Socket === "function") {
        ...
        const { CloudflareSocket: CloudflareSocket2 } = (init_dist(), dist_exports);
        return new CloudflareSocket2(ssl);
      }
    };
...
var require_libpq = __commonJS({
  "node_modules/libpq/index.js"(exports, module2) {
    ...
    var EventEmitter2 = require("events").EventEmitter;
    var assert13 = require("assert");
    for (key in EventEmitter2.prototype) {
    ...
    PQ.prototype.connect = function(paramString, cb) {
      ...
      assert13(cb, "Must provide a connection callback");
      if (process.domain) {
    ...
    PQ.prototype.execParams = function(commandText, parameters) {
      ...
      assert13(Array.isArray(parameters), "Parameters must be an array");
      this.$execParams(commandText, parameters);
    };
    PQ.prototype.prepare = function(statementName, commandText, nParams) {
      assert13.equal(arguments.length, 3, "Must supply 3 arguments");
      if (!statementName) {
        statementName = "";
      }
      if (!commandText) {
    ...
    PQ.prototype.startReader = function() {
      assert13(this.connected, "Must be connected to start reader");
      this.$startRead();
    };
    ...
    PQ.prototype.writable = function(cb) {
      assert13(this.connected, "Must be connected to start writer");
      this.$startWrite();
    ...
    PQ.prototype.putCopyData = function(buffer) {
      assert13(buffer instanceof Buffer);
...
var require_postgres_array2 = __commonJS({
  "node_modules/pg-native/node_modules/postgres-array/index.js"(exports) {
    "use strict";
    exports.parse = function(source, transform) {
      return new ArrayParser(source, transform).parse();
    };
...
var require_arrayParser2 = __commonJS({
  "node_modules/pg-native/node_modules/pg-types/lib/arrayParser.js"(exports, module2) {
...
var require_textParsers2 = __commonJS({
  "node_modules/pg-native/node_modules/pg-types/lib/textParsers.js"(exports, module2) {
    var array = require_postgres_array2();
...
var require_binaryParsers2 = __commonJS({
  "node_modules/pg-native/node_modules/pg-types/lib/binaryParsers.js"(exports, module2) {
    var parseInt64 = require_pg_int8();
    var parseBits = function(data, bits, offset, invert, callback) {
      offset = offset || 0;
      invert = invert || false;
...
var require_pg_types2 = __commonJS({
  "node_modules/pg-native/node_modules/pg-types/index.js"(exports) {
...
var require_build_result = __commonJS({
  "node_modules/pg-native/lib/build-result.js"(exports, module2) {
    "use strict";
    var Result = class {
...
var require_copy_stream = __commonJS({
  "node_modules/pg-native/lib/copy-stream.js"(exports, module2) {
...
var require_package = __commonJS({
  "node_modules/pg-native/package.json"(exports, module2) {
    module2.exports = {
      name: "pg-native",
      version: "3.0.1",
...
var require_pg_native = __commonJS({
  "node_modules/pg-native/index.js"(exports, module2) {
    ...
    Client2.prototype.cancel = function(cb) {
      assert13(cb, "Callback is required");
...
var require_nanoassert = __commonJS({
  "node_modules/nanoassert/index.js"(exports, module2) {
    module2.exports = assert13;
    var AssertionError = class extends Error {
    };
    AssertionError.prototype.name = "AssertionError";
    function assert13(t, m) {
      if (!t) {
        var err = new AssertionError(m);
        if (Error.captureStackTrace)
          Error.captureStackTrace(err, assert13);
        throw err;
      }
    }
  }
...
// node_modules/modern-async/src/findInternal.mjs
var import_nanoassert4 = __toModule(require_nanoassert());
...
// node_modules/modern-async/src/reduceRight.mjs
var import_nanoassert9 = __toModule(require_nanoassert());

// node_modules/modern-async/src/sleepCancellable.mjs
var import_nanoassert10 = __toModule(require_nanoassert());

// node_modules/modern-async/src/Scheduler.mjs
var import_nanoassert11 = __toModule(require_nanoassert());

// node_modules/modern-async/src/sleepPreciseCancellable.mjs
var import_nanoassert12 = __toModule(require_nanoassert());
...
// src/tables-and-views.mjs
var core2 = __toModule(require_core());
var tablesAndViews = `
SELECT table_name, table_type FROM information_schema.tables 
WHERE table_schema = 'public';
`;
var materializedViews = `select schemaname as schema_name,
...
async function run4(c) {
  core4.info("Clearing supabase migrations");
...
// src/users.mjs
var core7 = __toModule(require_core());
async function deleteUser(email, c) {
  core7.info(`Delete User : ${email}`);
  const u = await c.query(`SELECT email FROM "auth"."users" WHERE email = '${email}';`);
  if (u.rows.length > 0) {
    core7.info(`Found User : ${email} deleting...`);
    return c.query(`DELETE FROM "auth"."users" WHERE email = '${email}';`);
  }
  core7.info(`Delete User: ${email} not found, skipping...`);
  return true;
}
async function run7(users, c) {
...
async function run8(extensions, c) {
  await forEachSeries_default(extensions, async (ext) => {
